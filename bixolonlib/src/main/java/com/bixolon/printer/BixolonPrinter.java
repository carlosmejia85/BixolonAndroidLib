...
public class BixolonPrinter
{
    ...
    DirectIOListener directIOListener = new DirectIOListener()
    {
        @Override
    ...
    public BixolonPrinter(Context context)
    {
        ...
        posPrinter.addStatusUpdateListener      (   statusUpdateListener    );
        posPrinter.addErrorListener             (   errorListener           );
        posPrinter.addOutputCompleteListener    (   outputCompleteListener  );
        posPrinter.addDirectIOListener          (   directIOListener        );
...
//                    strOption += EscapeSequence.getString(26);
    ...
    public boolean printImage(String path, int width, int alignment, int brightness, int dither) {
        boolean ret = true;
    ...
    public boolean printImage(Bitmap bitmap, int width, int alignment, int brightness, int dither) {
        boolean ret = true;
