...
public class TabPagerAdapter extends FragmentStatePagerAdapter
{
    ...
    private int[] mTabTitle = {R.string.Text, R.string.Image, R.string.Barcode, R.string.PageMode, R.string.DirectIO, R.string.MSR, R.string.SCR, R.string.CashDrawer, R.string.ETC};
